...
namespace VirtoCommerce.Domain.Catalog.Services
{
    public interface IItemService
    {
        ...
        CatalogProduct GetByCode(string itemCode, ItemResponseGroup respGroup, string catalogId = null);
        CatalogProduct[] GetByCodes(string[] itemCodes, ItemResponseGroup respGroup, string catalogId = null);
